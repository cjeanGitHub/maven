...
public class MyWebSocketController {
    ...
    public static CopyOnWriteArraySet<MyWebSocketController> getWebSocketSet() {
        return webSocketSet;
    }

    public static void setWebSocketSet(CopyOnWriteArraySet<MyWebSocketController> webSocketSet) {
        MyWebSocketController.webSocketSet = webSocketSet;
    }
}